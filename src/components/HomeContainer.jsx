    ...
    return (
        ...
        >
            ...
            <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
                ...
                <button
                    type="button"
                    className="bg-gradient-to-br text-white from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
                >
                    Order Now
                </button>
            </div>
